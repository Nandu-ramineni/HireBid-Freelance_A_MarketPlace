...
const Rating = ({ bidId, freelancerId, freelancerName, jobTitle,jobId}) => {
    ...
    const handleSubmitRating = async () => {
        ...
        try {
            ...
            const ratingData = {
                ...
                comment: review.trim(),
                job: jobId,
                type: "client-to-freelancer" // Assuming this is a client to freelancer
            }
            ...
            <Card className="border-green-200 bg-green-50">
                <CardContent className="pt-6">
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-xs text-green-600">Thank you for your feedback on {freelancerName}</p>
                    </div>
                </CardContent>
            </Card>
        )
    ...
    return (
        <Card>
            ...
            <CardHeader className="pb-3">
                ...
                <p className="text-sm text-muted-foreground">How was working with <span className="font-semibold">{freelancerName}</span>?</p>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        id="review"
                        placeholder={`Share your experience working with ${freelancerName} on "${jobTitle}". What went well? Any areas for improvement?`}
                        value={review}
